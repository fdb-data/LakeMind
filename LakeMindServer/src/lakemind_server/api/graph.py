...
async def add_node(graph: str, body: AddNodeBody, request: Request):
    ...
    _eng(request).add_node(graph, nid, body.label, body.properties, body.tenant_id)
...
async def add_edge(graph: str, body: AddEdgeBody, request: Request):
    ...
    _eng(request).add_edge(graph, eid, body.src, body.dst, body.rel, body.properties, body.tenant_id)
